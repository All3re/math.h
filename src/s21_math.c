...
long double s21_pow_helper(double x, double y) {
  ...
  if (x_is_fin && !x_is_nan && x == +0 && x <= S21_EPS && y_min && ((int)y) < 0 && ((int)y) % 2) {
    result = S21_INF;
  }

  else if (x_is_fin && !x_is_nan && x == -0 && x <= S21_EPS && y_min && ((int)y) < 0 && ((int)y) % 2) {
    result = -S21_INF;
  }
  ...
  else if (x_is_fin && !x_is_nan && s21_fabs(x) < S21_EPS && y_is_fin && ((y_min && !(((int)y) % 2)) || !y_min)) {
    if (x == 0 && y == 0) {
      result = 1;
    }
    else if (x == 0 && y > 0) {
  ...
  else if (x_is_fin && !x_is_nan && s21_fabs(x) < S21_EPS && !y_is_nan && !y_is_fin && y < 0) {
    result = S21_INF;
  }

  // pow(+0, exp), where exp is a positive odd integer, returns +0
  else if (x_is_fin && !x_is_nan && x > 0 && x <= S21_EPS && y_min && ((int)y) % 2) {
    result = +0;
  }
  ...
  //  integer, returns +0
  else if (x_is_fin && !x_is_nan && s21_fabs(x) < S21_EPS && ((!y_min && s21_fabs(y) > S21_EPS) || (y_min && !(((int)y) % 2)))) {
    result = +0;
  }

  // pow(-1, ±∞) returns 1
  else if (x_is_fin && !x_is_nan && s21_fabs(x + 1) < S21_EPS && !y_is_fin && !y_is_nan) {
    result = 1;
  }
  ...
  // even integer
  else if (!x_is_nan && !x_is_fin && x < 0 && ((!y_min && y < 0) || (y_min && y < 0 && !(((int)y) % 2)))) {
    result = +0;
  }

  // pow(-∞, exp) returns -∞ if exp is a positive odd integer
  else if (!x_is_nan && !x_is_fin && x < 0 && (y_min && y > 0 && ((int)y) & 1)) {
    result = -S21_INF;
  }
...
long double s21_pow(double x, double y) {
    ...
    else if (s21_pow_helper(x, y) != -123.5) {
